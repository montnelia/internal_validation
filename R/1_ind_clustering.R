...
require(RANN)
require(mclust)
require(MLmetrics) #F1_Score
require(funtimes) # purity
require(phateR)
require(umap)
require(Rtsne)
require(cluster)
...
setwd("C:/Users/ri89por/Desktop/Forschung/Github/internal_validation/")
getwd()
